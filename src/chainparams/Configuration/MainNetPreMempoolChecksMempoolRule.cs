...
namespace ChainParams.Configuration
{
    ...
    /// </summary>
    public class MainNetPreMempoolChecksMempoolRule : MempoolRule
    {
        readonly IDateTimeProvider dateTimeProvider;
        readonly NodeSettings nodeSettings;
        readonly CheckPowTransactionRule checkPowTransactionRule;
        ...
        static bool CheckFinalTransaction(ChainIndexer chainIndexer, IDateTimeProvider dateTimeProvider, Transaction tx)
        {
