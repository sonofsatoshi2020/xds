...
{
    public class MainNetMempoolValidator : IMempoolValidator
    {
        readonly Network network;
        readonly ITxMempool txMemPool;
        ...
        readonly IEnumerable<IMempoolRule> mempoolRules;
        readonly ILogger logger;
        readonly FeeRate minRelayTxFee;

        public MainNetMempoolValidator(
            Network network,
