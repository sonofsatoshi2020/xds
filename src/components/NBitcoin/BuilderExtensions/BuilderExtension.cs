...
namespace NBitcoin.BuilderExtensions
{
    ...
    public abstract class BuilderExtension
    {
        ...
        public static TransactionSignature DummySignature = new TransactionSignature(
        ...
        public abstract Script GenerateScriptSig(Network network, Script scriptPubKey, IKeyRepository keyRepo,
            ISigner signer);
