...
namespace NBitcoin
{
    public class uint256
    {
        ...
        {
            if (vch.Length != WIDTH_BYTE) throw new FormatException("the byte array should be 256 byte long");
        ...
        uint[] ToArray()
        {
            return new[] {this.pn0, this.pn1, this.pn2, this.pn3, this.pn4, this.pn5, this.pn6, this.pn7};
        }
        ...
        public class MutableUint256 : IBitcoinSerializable
        {
            ...
            public uint256 MaxValue => Parse("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");

            public void ReadWrite(BitcoinStream stream)
            {
                if (stream.Serializing)
                {
                    var b = this.Value.ToBytes();
    ...
    public class uint160
    {
        ...
        {
            if (vch.Length != WIDTH_BYTE) throw new FormatException("the byte array should be 160 byte long");
        ...
        static int Comparison(uint160 a, uint160 b)
        {
            if (a.pn4 < b.pn4)
                return -1;
            if (a.pn4 > b.pn4)
