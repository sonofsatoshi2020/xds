...
namespace NBitcoin
{
    public class CachedTransactionRepository : ITransactionRepository
    {
        ...
        readonly ITransactionRepository _Inner;
        readonly Dictionary<uint256, Transaction> _Transactions = new Dictionary<uint256, Transaction>();
        ...
        public int MaxCachedTransactions { get; set; }
        ...
        void EvictIfNecessary(uint256 txId)
        {
            ...
            while (this._Transactions.Count > this.MaxCachedTransactions && this._EvictionQueue.Count > 0)
                this._Transactions.Remove(this._EvictionQueue.Dequeue());
        }
