...
namespace NBitcoin
{
    ...
    public class BlockStake : IBitcoinSerializable
    {
        ...
        public static bool Validate(Network network, ChainedHeader chainedHeader)
        {
            ...
            var hashPrevCorrect = chainedHeader.Height == 0 ||
                                  chainedHeader.Header.HashPrevBlock == chainedHeader.Previous.HashBlock;
    ...
    {
        uint nTime = Utils.DateTimeToUnixTime(DateTime.UtcNow);
    ...
    public class PosConsensusFactory : ConsensusFactory
    {
        ...
        /// </summary>
        readonly ConcurrentDictionary<Type, bool> isAssignableFromProvenBlockHeader =
            new ConcurrentDictionary<Type, bool>();

        /// <summary>
        ///     The <see cref="ProvenBlockHeader" /> type.
        /// </summary>
        readonly TypeInfo provenBlockHeaderType = typeof(ProvenBlockHeader).GetTypeInfo();
        ...
        {
            return IsAssignable<T>(this.provenBlockHeaderType, this.isAssignableFromProvenBlockHeader);
        }
...
#pragma warning restore 618
    {
        ...
        public override uint256 GetHash()
        {
            ...
            if (innerHashes != null) innerHashes[0] = hash;
    ...
    public class PosBlock : Block
    {
        ...
        ///     <para>
        ///         In PoW there isn't a coinstake transaction, return coinbase instead to be able to compute stake modifier for
        ///         the next eventual PoS block.
        ///     </para>
        /// </remarks>
        public Transaction GetProtocolTransaction()
        {
            return this.Transactions.Count > 1 && this.Transactions[1].IsCoinStake
                ? this.Transactions[1]
                : this.Transactions[0];
        }
    }
