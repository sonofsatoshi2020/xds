...
namespace NBitcoin
{
    ...
    public struct Sequence
    {
        ...
        readonly uint _ValueInv;
        public uint Value => 0xFFFFFFFF - this._ValueInv;
        ...
        public Sequence(TimeSpan period)
        {
            if (period.TotalSeconds > 0xFFFF * 512 || period.TotalSeconds < 0)
                throw new ArgumentOutOfRangeException("Relative lock time must be positive and lower or equals to " +
        ...
        public bool IsRelativeLock => (this.Value & SEQUENCE_LOCKTIME_DISABLE_FLAG) == 0;

        public bool IsRBF => this.Value < 0xffffffff - 1;
        ...
        public SequenceLockType LockType
        {
            ...
            {
                AssertRelativeLock();
                return (this.Value & SEQUENCE_LOCKTIME_TYPE_FLAG) != 0
                    ? SequenceLockType.Time
                    : SequenceLockType.Height;
            }
        }
        ...
        public TimeSpan LockPeriod
        {
            get
            {
                ...
                return TimeSpan.FromSeconds((int) (this.Value & SEQUENCE_LOCKTIME_MASK) *
