...
namespace NBitcoin
{
    ...
    {
        static readonly byte[] pchOnionCat = {0xFD, 0x87, 0xD8, 0x7E, 0xEB, 0x43};
        ...
        public static bool IsRFC6598(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 100 && (bytes[15 - 2] & 0xc0) == 64;
        }
        ...
        public static bool IsRFC7535(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 192 && bytes[15 - 2] == 31 && bytes[15 - 1] == 196;
        }
        ...
        public static bool IsRFC7450(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 192 && bytes[15 - 2] == 52 && bytes[15 - 1] == 193;
        }
        ...
        public static bool IsRFC7526(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 192 && bytes[15 - 2] == 88 && bytes[15 - 1] == 99;
        }
        ...
        public static bool IsRFC2544(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 198 && (bytes[15 - 2] & 254) == 18;
        }
        ...
        public static bool IsRFC1112(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && (bytes[15 - 3] & 240) == 240;
        }
        ...
        public static bool IsRFC6890(this IPAddress address)
        {
            address = address.EnsureIPv6();
            var bytes = address.GetAddressBytes();
            return address.IsIPv4() && bytes[15 - 3] == 192 && bytes[15 - 2] == 0 && bytes[15 - 1] == 0;
        }
