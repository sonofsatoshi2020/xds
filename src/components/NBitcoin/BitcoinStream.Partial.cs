...
namespace NBitcoin
{
    public partial class BitcoinStream
    {
        ...
        void ReadWriteArray<T>(ref T[] data) where T : IBitcoinSerializable
        {
        ...
        void ReadWriteArray(ref ulong[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref ushort[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref uint[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref long[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref short[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref int[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
        ...
        void ReadWriteArray(ref string[] data)
        {
            if (data == null && this.Serializing)
                throw new ArgumentNullException("Impossible to serialize a null array");
            this._VarInt.SetValue(data == null ? 0 : (ulong) data.Length);
