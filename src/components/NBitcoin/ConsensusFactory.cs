...
namespace NBitcoin
{
    ...
    public class ConsensusFactory
    {
        ...
        /// </summary>
        readonly TypeInfo blockHeaderType = typeof(BlockHeader).GetTypeInfo();

        /// <summary>
        ///     The <see cref="Block" /> type.
        /// </summary>
        readonly TypeInfo blockType = typeof(Block).GetTypeInfo();


        /// <summary>
        ///     A dictionary for types assignable from <see cref="Block" />.
        /// </summary>
        readonly ConcurrentDictionary<Type, bool> isAssignableFromBlock = new ConcurrentDictionary<Type, bool>();

        /// <summary>
        ///     A dictionary for types assignable from <see cref="BlockHeader" />.
        /// </summary>
        readonly ConcurrentDictionary<Type, bool> isAssignableFromBlockHeader = new ConcurrentDictionary<Type, bool>();

        /// <summary>
        ///     A dictionary for types assignable from <see cref="Transaction" />.
        /// </summary>
        readonly ConcurrentDictionary<Type, bool> isAssignableFromTransaction = new ConcurrentDictionary<Type, bool>();

        /// <summary>
        ///     The <see cref="Transaction" /> type.
        /// </summary>
        readonly TypeInfo transactionType = typeof(Transaction).GetTypeInfo();
        ...
        {
            if (!cache.TryGetValue(typeof(T), out var isAssignable))
            {
