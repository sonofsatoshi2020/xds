...
namespace NBitcoin
{
    public class BIP9DeploymentsParameters
    {
        ...
        /// <summary>
        ///     Determines which bit in the nVersion field of the block is to be used to signal the soft fork lock-in and
        ///     activation. It is chosen from the set {0,1,2,...,28}.
        /// </summary>
        public int Bit { get; }
        ...
        /// <summary>
        ///     Specifies a time at which the deployment is considered failed. If the median time past of a block >= timeout and
        ///     the soft fork has not yet locked in
        ///     (including that block's bit state), the deployment is considered failed on all descendants of the block.
        /// </summary>
        ...
        /// <summary>
        ///     Specifies the activation threshold for this deployment. The BIP9 specification originally set the threshold at
        ///     >=1916 blocks (95% of 2016),
        ///     or >=1512 for testnet (75% of 2016).
        /// </summary>
