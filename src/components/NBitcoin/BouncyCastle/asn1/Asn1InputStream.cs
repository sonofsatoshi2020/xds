        ...
        : FilterStream
    {
        ...
        */
            ...
            int length)
        {
            ...
            if ((tag & Asn1Tags.Application) != 0) throw new IOException("invalid ECDSA sig");

            if ((tag & Asn1Tags.Tagged) != 0) throw new IOException("invalid ECDSA sig");
        ...
        public Asn1Object ReadObject()
        {
            ...
            //
            var tagNo = ReadTagNumber(this.s, tag);
            ...
            // calculate length
            //
            var length = ReadLength(this.s, this.limit);
