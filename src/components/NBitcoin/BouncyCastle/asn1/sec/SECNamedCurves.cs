...
{
    sealed class SecNamedCurves
    {
        static readonly IDictionary objIds = Platform.CreateHashtable();
        static readonly IDictionary curves = Platform.CreateHashtable();
        static readonly IDictionary names = Platform.CreateHashtable();
