        ...
        : IBlockCipher
    {
        ...
        */
        uint[][] GenerateWorkingKey(byte[] key, bool forEncryption)
        {
            ...
            for (var i = 0; i <= this.ROUNDS; ++i) W[i] = new uint[4];
        ...
        void EncryptBlock(uint[][] KW)
        {
            ...
            kw = KW[r];
            this.C0 = S[r0 & 255] ^ ((uint) S[(r1 >> 8) & 255] << 8) ^ ((uint) S[(r2 >> 16) & 255] << 16) ^
                      ((uint) S[r3 >> 24] << 24) ^ kw[0];
            this.C1 = S[r1 & 255] ^ ((uint) S[(r2 >> 8) & 255] << 8) ^ ((uint) S[(r3 >> 16) & 255] << 16) ^
                      ((uint) S[r0 >> 24] << 24) ^ kw[1];
            this.C2 = S[r2 & 255] ^ ((uint) S[(r3 >> 8) & 255] << 8) ^ ((uint) S[(r0 >> 16) & 255] << 16) ^
                      ((uint) S[r1 >> 24] << 24) ^ kw[2];
            this.C3 = S[r3 & 255] ^ ((uint) S[(r0 >> 8) & 255] << 8) ^ ((uint) S[(r1 >> 16) & 255] << 16) ^
                      ((uint) S[r2 >> 24] << 24) ^ kw[3];
        }

        void DecryptBlock(uint[][] KW)
        {
            var kw = KW[this.ROUNDS];
            var t0 = this.C0 ^ kw[0];
            var t1 = this.C1 ^ kw[1];
            var t2 = this.C2 ^ kw[2];
            ...
            kw = KW[0];
            this.C0 = Si[r0 & 255] ^ ((uint) Si[(r3 >> 8) & 255] << 8) ^ ((uint) Si[(r2 >> 16) & 255] << 16) ^
                      ((uint) Si[r1 >> 24] << 24) ^ kw[0];
            this.C1 = Si[r1 & 255] ^ ((uint) Si[(r0 >> 8) & 255] << 8) ^ ((uint) Si[(r3 >> 16) & 255] << 16) ^
                      ((uint) Si[r2 >> 24] << 24) ^ kw[1];
            this.C2 = Si[r2 & 255] ^ ((uint) Si[(r1 >> 8) & 255] << 8) ^ ((uint) Si[(r0 >> 16) & 255] << 16) ^
                      ((uint) Si[r3 >> 24] << 24) ^ kw[2];
            this.C3 = Si[r3 & 255] ^ ((uint) Si[(r2 >> 8) & 255] << 8) ^ ((uint) Si[(r1 >> 16) & 255] << 16) ^
