...
namespace NBitcoin.BouncyCastle.math.ec.abc
{
    ...
    */
    class Tnaf
    {
        ...
        {
            null, new sbyte[] {1}, null, new sbyte[] {-1, 0, 1}, null, new sbyte[] {1, 0, 1}, null,
            new sbyte[] {-1, 0, 0, 1}
        };
         ...
         * <code>&#956;</code>
         * of the elliptic curve.
         * @param u The real part of the element
         * <code>&#955;</code>
         * of
         * <code><b>R</b>[&#964;]</code>
         * .
            ...
            SimpleBigDecimal lambda1, sbyte mu)
        {
            ...
            {
                // eta < 1
                if (check2.CompareTo(BigInteger.Two) >= 0) h1 = mu;
            }
            ...
            {
                // eta >= -1
                if (check2.CompareTo(MinusTwo) < 0) h1 = (sbyte) -mu;
            }
         ...
         * .
         * @param vm The Lucas Sequence element
         * <code>V<sub>m</sub></code>
         * .
         ...
         * . 
         * @param p The AbstractF2mPoint to which
         * <code>&#964;()</code>
         * is applied.
         * @return
         * <code>&#964;(p)</code>
         ...
         * <code>&#956;</code>
         * .
         * The curve must be a Koblitz curve, i.e.
         * <code>a</code>
         * Equals
         * <code>0</code>
         * or
        ...
        /**
         * Calculates the Lucas Sequence elements
         * <code>U<sub>k-1</sub></code>
         * and
         * <code>U<sub>k</sub></code>
         * or
         * <code>V<sub>k-1</sub></code>
         * and
         ...
         * returned.
         * @param doV If set to true, computes
         * <code>V<sub>k-1</sub></code>
         * and
         * <code>V<sub>k</sub></code>
         * , otherwise
         ...
         * <code>U<sub>k</sub></code>
         * .
         * @return An array with 2 elements, containing
         * <code>U<sub>k-1</sub></code>
         * and
         * <code>U<sub>k</sub></code>
         * or
        ...
        /**
         * Computes the auxiliary value
         * <code>t<sub>w</sub></code>
         * . If the width is
         * 4, then for
         * <code>mu = 1</code>
         * ,
         * <code>t<sub>w</sub> = 6</code>
         * and for
         * <code>mu = -1</code>
         * ,
        ...
        public static BigInteger[] GetSi(AbstractF2mCurve curve)
        {
            ...
            return new[] {dividend0, dividend1};
        }
         ...
         * modular reduction.
         * @return
         * <code>&#961; := k partmod (&#964;<sup>m</sup> - 1)/(&#964; - 1)</code>
         */
        ...
        public static AbstractF2mPoint MultiplyRTnaf(AbstractF2mPoint p, BigInteger k)
        {
            ...
            var mu = GetMu(a);
            var s = curve.GetSi();
            var rho = PartModReduction(k, m, (sbyte) a, s, mu, 10);
         ...
         * <code>a</code>
         * of the elliptic curve.
         * @return The precomputation array for
         * <code>p</code>
         * .
         */
        public static AbstractF2mPoint[] GetPreComp(AbstractF2mPoint p, sbyte a)
        {
            var alphaTnaf = a == 0 ? Alpha0Tnaf : Alpha1Tnaf;

            var pu = new AbstractF2mPoint[(uint) (alphaTnaf.Length + 1) >> 1];
            pu[0] = p;

            var precompLen = (uint) alphaTnaf.Length;
            for (uint i = 3; i < precompLen; i += 2) pu[i >> 1] = MultiplyFromTnaf(p, alphaTnaf[i]);
