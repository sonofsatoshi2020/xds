...
namespace NBitcoin.BouncyCastle.math.ec.custom.sec
{
    class SecP256K1Field
    {
        ...
        static readonly uint[] PExtInv =
        {
            0xFFF16F5F, 0xFFFFF85D, 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
        ...
        public static void Add(uint[] x, uint[] y, uint[] z)
        {
            ...
            if (c != 0 || z[7] == P7 && Nat256.Gte(z, P)) Nat.Add33To(8, PInv33, z);
        }
        ...
        public static uint[] FromBigInteger(BigInteger x)
        {
            ...
            if (z[7] == P7 && Nat256.Gte(z, P)) Nat256.SubFrom(P, z);
            return z;
        }
        ...
        {
            var cc = Nat256.Mul33Add(PInv33, xx, 8, xx, 0, z, 0);
            var c = Nat256.Mul33DWordAdd(PInv33, cc, z, 0);
        ...
        public static void Subtract(uint[] x, uint[] y, uint[] z)
        {
            ...
            if (c != 0) Nat.Sub33From(8, PInv33, z);
        }
