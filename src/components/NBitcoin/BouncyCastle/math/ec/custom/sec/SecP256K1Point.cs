...
namespace NBitcoin.BouncyCastle.math.ec.custom.sec
{
        ...
        : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            if (!Z1IsOne) SecP256K1Field.Multiply(Z3.x, Z1.x, Z3.x);
            if (!Z2IsOne) SecP256K1Field.Multiply(Z3.x, Z2.x, Z3.x);
        ...
        public override ECPoint Twice()
        {
            ...
            if (!Z1.IsOne) SecP256K1Field.Multiply(Z3.x, Z1.x, Z3.x);
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecP256K1Point(this.Curve, this.RawXCoord, this.RawYCoord.Negate(), this.RawZCoords,
                this.IsCompressed);
        }
    }
}