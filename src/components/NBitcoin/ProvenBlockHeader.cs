...
namespace NBitcoin
{
    ...
    ///     </para>
    ///     <para>
    ///         Proven header prevents such an attack by including additional information that can be validated and confirmed
    ///         whether
    ...
    ///     </para>
    ///     <para>
    ///         Merkle proof (<see cref="MerkleProof" />) that proves the coinstake tx is included in a block that is being
    ///         represented by the provided header.
    ///     </para>
    /// </remarks>
    public class ProvenBlockHeader : PosBlockHeader
    {
        ...
        /// <summary>
        ///     Gets merkle proof that proves the coinstake tx is included in a block that is being represented by the provided
        ///     header.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the size of the merkle proof in bytes, the header must be serialized or deserialized for this property to
        ///     be set.
        /// </summary>
        public long MerkleProofSize { get; protected set; }

        /// <summary>
        ///     Gets the size of the signature in bytes, the header must be serialized or deserialized for this property to be
        ///     set.
        /// </summary>
        public long SignatureSize { get; protected set; }

        /// <summary>
        ///     Gets the size of the coinstake in bytes, the header must be serialized or deserialized for this property to be
        ///     set.
        /// </summary>
        public long CoinstakeSize { get; protected set; }

        /// <summary>
        ///     Gets the total header size - including the <see cref="BlockHeader.Size" /> - in bytes.
        ///     <see cref="ProvenBlockHeader" /> must be serialized or deserialized for this property to be set.
        /// </summary>
        ...
        public override void ReadWrite(BitcoinStream stream)
        {
            ...
            var prev = stream.ProcessedBytes;
