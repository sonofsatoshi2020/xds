...
namespace NBitcoin
{
    ...
    public class BlockHeader : IBitcoinSerializable
    {
        ...
        {
            get => this.hashPrevBlock;
            set => this.hashPrevBlock = value;
        }
        ...
        {
            get => this.hashMerkleRoot;
            set => this.hashMerkleRoot = value;
        }
        ...
        {
            get => Utils.UnixTimeToDateTime(this.time);
        ...
        /// <param name="lazily">
        ///     If <c>true</c>, the hash will be calculated and cached at the first call to GetHash(), else it
        ///     will be immediately.
        /// </param>
