...
namespace NBitcoin.Stealth
{
    ...
    {
        static readonly TxNullDataTemplate _Template = new TxNullDataTemplate(1024 * 4);
        ...
        public PubKey EphemKey { get; private set; }
        ...
        static bool Fill(StealthMetadata output, Script metadata)
        {
        ...
        static bool Fill(StealthMetadata output, Script metadata, byte[] data)
        {
