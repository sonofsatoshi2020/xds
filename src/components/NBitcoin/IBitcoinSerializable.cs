...
namespace NBitcoin
{
    ...
    public static class BitcoinSerializableExtensions
    {
        ...
        public static int GetSerializedSize(this IBitcoinSerializable serializable, ProtocolVersion version,
        ...
        public static string ToHex(this IBitcoinSerializable serializable, Network network,
            SerializationType serializationType = SerializationType.Disk)
        {
        ...
        public static T Clone<T>(this T serializable, ProtocolVersion version = ProtocolVersion.PROTOCOL_VERSION)
            where T : IBitcoinSerializable, new()
        {
            var instance = new DefaultConsensusFactory().TryCreateNew<T>();
            if (instance == null)
                instance = new T();
