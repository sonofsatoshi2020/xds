...
namespace NBitcoin
{
    ...
    public class DNSSeedData
    {
        ...
        ///     Normally the DNS lookups get cached after the first resolution. This indicates that the
        ///     results should be discarded and overwritten.
        /// </param>
        /// <returns>A list of IP addresses.</returns>
        public IPAddress[] GetAddressNodes(bool forceRefresh = false)
        {
            if (this.addresses != null && !forceRefresh) return this.addresses;
