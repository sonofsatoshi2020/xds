...
namespace NBitcoin.BIP32
{
    ...
    public class ExtKey : IBitcoinSerializable, IDestination, ISecret
    {
        ...
        /// </summary>
        public Script ScriptPubKey => this.PrivateKey.PubKey.Hash.ScriptPubKey;
        ...
        /// </summary>
        public Key PrivateKey => this.key;
        ...
        byte[] CalculateChildFingerprint()
        {
