...
namespace NBitcoin
{
    ...
    public class ConsensusOptions
    {
        ...
        /// <summary>
        ///     Scale of witness vs other transaction data. e.g. if set to 4, then witnesses have 1/4 the weight per byte of
        ...
        ///         <item>
        ///             and then later date bumping the default CURRENT_VERSION at which point both CURRENT_VERSION and
        ///             <see cref="MaxStandardVersion" /> will be equal.
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        /// <summary>
        ///     Block Height at which the node should enforce the use of <see cref="EnforcedMinProtocolVersion" />.
        ///     Can be set to zero to indicate that the minimum supported protocol version will not change depending on the block
        ///     height.
        /// </summary>
        public int EnforceMinProtocolVersionAtBlockHeight { get; set; }

        /// <summary>
        ///     The minimum protocol version which should be used from block height defined in
        ///     <see cref="EnforceMinProtocolVersionAtBlockHeight" />
        /// </summary>
    ...
    ///     Doesn't make much sense for it to be in NBitcoin. Also remove the CoinstakeMinConfirmation consts and set
    ///     CointakeMinConfirmation in Network building.
    /// </summary>
    public class PosConsensusOptions : ConsensusOptions
    {
        ...
        public PosConsensusOptions(
            ...
            int maxStandardTxWeight,
            int maxBlockSigopsCost,
            int maxStandardTxSigopsCost) : base(maxBlockBaseSize, maxBlockWeight, maxBlockSerializedSize,
