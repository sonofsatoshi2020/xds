...
namespace UnnamedCoin.Bitcoin.Features.Consensus.CoinViews
{
    ...
    public interface ICoinView
    {
        ...
        uint256 GetTipHash(CancellationToken cancellationToken = default);
        ...
        ///     </para>
        /// </summary>
        /// <param name="unspentOutputs">
        ///     Information about the changes between the old block and the new block. An item in this list represents a list of
        ///     all outputs
        ///     for a specific transaction. If a specific output was spent, the output is <c>null</c>.
        /// </param>
        /// <param name="originalOutputs">
        ///     Information about the previous state of outputs of transactions inside <paramref name="unspentOutputs" />. If an
        ///     item here is <c>null</c>,
        ///     it means that the ouputs are newly created in the new block. If it is not <c>null</c>, it holds information about
        ///     which outputs of the transaction were previously spent
        ///     and which were not.
        /// </param>
        ...
        /// <param name="rewindDataList">
        ///     List of rewind data items to be persisted. This should only be used when calling
        ///     <see cref="DBreezeCoinView.SaveChanges" />.
        /// </param>
        void SaveChanges(IList<UnspentOutputs> unspentOutputs, IEnumerable<TxOut[]> originalOutputs,
            uint256 oldBlockHash, uint256 nextBlockHash, int height, List<RewindData> rewindDataList = null);

        /// <summary>
        ///     Obtains information about unspent outputs for specific transactions and also retrieves information about the
        ///     coinview's tip.
        /// </summary>
        ...
        ///     <para>
        ///         i-th item in <see cref="FetchCoinsResponse.UnspentOutputs" /> array is the information of the unspent outputs
        ///         for i-th transaction in <paramref name="txIds" />.
        ///         If the i-th item of <see cref="FetchCoinsResponse.UnspentOutputs" /> is <c>null</c>, it means that there are no
        ///         unspent outputs in the given transaction.
        ///     </para>
        /// </returns>
        FetchCoinsResponse FetchCoins(uint256[] txIds, CancellationToken cancellationToken = default);
