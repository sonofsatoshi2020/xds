...
namespace UnnamedCoin.Bitcoin.Features.Consensus.Rules.CommonRules
{
    ...
    public class CheckPowTransactionRule : PartialValidationConsensusRule
    {
        ...
        /// <exception cref="ConsensusErrors.BadTransactionOversize">
        ///     Thrown if transaction size is greater than maximum allowed
        ///     size of a block.
        /// </exception>
        /// <exception cref="ConsensusErrors.BadTransactionNegativeOutput">
        ///     Thrown if at least one transaction output has negative
        ///     value.
        /// </exception>
        /// <exception cref="ConsensusErrors.BadTransactionTooLargeOutput">
        ///     Thrown if at least one transaction output value is
        ///     greater than maximum allowed one.
        /// </exception>
        /// <exception cref="ConsensusErrors.BadTransactionTooLargeTotalOutput">
        ///     Thrown if sum of all transaction outputs is greater
        ///     than maximum allowed one.
        /// </exception>
        ...
        bool MoneyRange(IConsensus consensus, long nValue)
        {
