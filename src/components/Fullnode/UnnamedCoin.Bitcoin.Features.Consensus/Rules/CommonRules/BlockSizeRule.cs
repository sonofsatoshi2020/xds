...
namespace UnnamedCoin.Bitcoin.Features.Consensus.Rules.CommonRules
{
    ...
    public class BlockSizeRule : PartialValidationConsensusRule
    {
        ...
        /// <exception cref="ConsensusErrors.BadBlockLength">
        ///     The amount of transactions inside the block is higher than the allowed
        ///     max block base size.
        /// </exception>
        ...
        public override Task RunAsync(RuleContext context)
        {
            ...
            if (block.Transactions.Count == 0 || block.Transactions.Count > consensus.Options.MaxBlockBaseSize ||
                block.GetSize(TransactionOptions.None, this.Parent.Network.Consensus.ConsensusFactory) >
                consensus.Options.MaxBlockBaseSize)
            {
