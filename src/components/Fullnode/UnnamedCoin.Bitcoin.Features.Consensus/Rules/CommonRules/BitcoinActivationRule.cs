...
{
    /// <summary>
    ///     Check that a <see cref="BitcoinMain" /> network block has the correct version according to the defined active
    ///     deployments.
    /// </summary>
    public class BitcoinActivationRule : HeaderValidationConsensusRule
    {
        ...
        public override void Run(RuleContext context)
        {
            ...
            if (header.Version < 2 &&
                height >= this.Parent.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP34] ||
                header.Version < 3 &&
                height >= this.Parent.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP66] ||
