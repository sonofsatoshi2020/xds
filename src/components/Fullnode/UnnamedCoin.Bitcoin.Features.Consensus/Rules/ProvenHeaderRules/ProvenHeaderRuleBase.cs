...
namespace UnnamedCoin.Bitcoin.Features.Consensus.Rules.ProvenHeaderRules
{
    ...
    ///     This should be allowed by the behaviors only for whitelisted nodes.
    /// </remarks>
    ...
    public abstract class ProvenHeaderRuleBase : HeaderValidationConsensusRule
    {
        ...
        /// <summary>
        ///     Determines whether proven headers are activated based on the proven header activation height and applicable
        ///     network.
        /// </summary>
        ...
        public override void Run(RuleContext context)
        {
            ...
            Guard.NotNull(context.ValidationContext.ChainedHeaderToValidate,
                nameof(context.ValidationContext.ChainedHeaderToValidate));
            ...
            if (!IsProvenHeader(chainedHeader.Header))
            {
        ...
        protected abstract void ProcessRule(PosRuleContext context, ChainedHeader chainedHeader,
