...
namespace UnnamedCoin.Bitcoin.Features.MemoryPool
{
    ...
    public class MempoolCoinView : ICoinView, IBackedCoinView
    {
        ...
        readonly SchedulerLock mempoolLock;
        ...
        public MempoolCoinView(ICoinView inner, ITxMempool memPool, SchedulerLock mempoolLock,
        ...
        /// </summary>
        public UnspentOutputSet Set { get; }
        ...
        public void LoadViewLocked(Transaction trx)
        {
            ...
            var coins = this.Inner.FetchCoins(ids.ToArray());

            // find coins currently in the mempool
            var mempoolcoins = this.memPool.MapTx.Values.Where(t => ids.Contains(t.TransactionHash))
        ...
        double ComputePriority(Transaction trx, double dPriorityInputs, int nTxSize = 0)
        {
