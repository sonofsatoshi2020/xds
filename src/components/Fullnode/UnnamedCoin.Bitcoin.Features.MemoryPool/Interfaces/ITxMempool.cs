...
namespace UnnamedCoin.Bitcoin.Features.MemoryPool.Interfaces
{
    /// <summary>
    ...
    public interface ITxMempool
    {
        ...
        /// </remarks>
        bool AddUnchecked(uint256 hash, TxMempoolEntry entry, TxMempool.SetEntries setAncestors,
        ...
        /// <param name="fSearchForParents">
        ///     Whether to search a tx's vin for in-mempool parents, or look up parents from mapLinks.
        ///     Must be true for entries not in the mempool.
        /// </param>
        /// <returns>Whether operation was successful.</returns>
        bool CalculateMemPoolAncestors(TxMempoolEntry entry, TxMempool.SetEntries setAncestors, long limitAncestorCount,
