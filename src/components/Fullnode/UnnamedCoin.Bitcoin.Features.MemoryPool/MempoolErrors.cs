...
namespace UnnamedCoin.Bitcoin.Features.MemoryPool
{
    ...
    public class MempoolErrorException : Exception
    {
        ...
        public MempoolValidationState ValidationState { get; }
    }
    ...
    public static class MempoolErrors
    {
        ...
        public static MempoolError NonstandardInputs =
            new MempoolError(RejectNonstandard, "bad-txns-nonstandard-inputs");
        ...
        public static MempoolError InsufficientPriority =
            new MempoolError(RejectInsufficientfee, "insufficient-priority");
        ...
        public static MempoolError BadTxnsSpendsConflictingTx =
            new MempoolError(RejectInvalid, "bad-txns-spends-conflicting-tx");

        /// <summary>'too-many-potential-replacements' error returns a <see cref="RejectNonstandard" /> reject code.</summary>
        public static MempoolError TooManyPotentialReplacements =
            new MempoolError(RejectNonstandard, "too-many-potential-replacements");

        /// <summary>'replacement-adds-unconfirmed' error returns a <see cref="RejectNonstandard" /> reject code.</summary>
        public static MempoolError ReplacementAddsUnconfirmed =
            new MempoolError(RejectNonstandard, "replacement-adds-unconfirmed");

        /// <summary>'insufficient-fee' error returns a <see cref="RejectInsufficientfee" /> reject code.</summary>
        public static MempoolError Insufficientfee = new MempoolError(RejectInsufficientfee, "insufficient-fee");

        /// <summary>'mandatory-script-verify-flag-failed' error returns a <see cref="RejectInvalid" /> reject code.</summary>
        public static MempoolError MandatoryScriptVerifyFlagFailed =
            new MempoolError(RejectInvalid, "mandatory-script-verify-flag-failed");

        /// <summary>'non-mandatory-script-verify-flag' error returns a <see cref="RejectNonstandard" /> reject code.</summary>
        public static MempoolError NonMandatoryScriptVerifyFlagFailed =
            new MempoolError(RejectNonstandard, "non-mandatory-script-verify-flag");
        ...
        public static MempoolError TransactionContainsDustTxOuts =
            new MempoolError(RejectInvalid, "mempool-tx-contains-dust-outputs");
