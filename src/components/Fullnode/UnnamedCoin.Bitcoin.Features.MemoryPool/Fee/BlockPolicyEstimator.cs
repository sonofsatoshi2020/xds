...
namespace UnnamedCoin.Bitcoin.Features.MemoryPool.Fee
{
    /// <summary>
    ...
    public class BlockPolicyEstimator
    {
        ...
        readonly FeeRate minTrackedFee;
        ...
        public BlockPolicyEstimator(MempoolSettings mempoolSettings, ILoggerFactory loggerFactory,
        ...
        public FeeRate EstimateFee(int confTarget)
        {
            ...
            var median = this.feeStats.EstimateMedianVal(confTarget, SufficientFeeTxs, MinSuccessPct, true,
        ...
        public FeeRate EstimateSmartFee(int confTarget, ITxMempool pool, out int answerFoundAtTarget)
        {
            ...
            if (pool != null)
            {
                var minPoolFee = pool.GetMinFee(this.mempoolSettings.MaxMempool * 1000000).FeePerK;
