...
namespace UnnamedCoin.Bitcoin.Features.MemoryPool.Fee
{
    ...
    public class TxConfirmStats
    {
        ...
        Dictionary<double, int> bucketMap;
        ...
        /// </summary>
        /// <param name="blocksToConfirm">
        ///     The number of blocks it took this transaction to confirm. blocksToConfirm is 1-based and
        ///     has to be >= 1.
        /// </param>
        ...
        /// <param name="requireGreater">
        ///     Return the lowest feerate such that all higher values pass minSuccess OR return the
        ///     highest feerate such that all lower values fail minSuccess.
        /// </param>
            ...
            int nBlockHeight)
        {
            ...
            for (var bucket = startbucket; bucket >= 0 && bucket <= maxbucketindex; bucket += step)
            {
                ...
                for (var confct = confTarget; confct < GetMaxConfirms(); confct++)
