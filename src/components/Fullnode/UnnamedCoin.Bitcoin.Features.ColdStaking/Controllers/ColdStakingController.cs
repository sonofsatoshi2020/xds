...
namespace UnnamedCoin.Bitcoin.Features.ColdStaking.Controllers
{
    ...
    public class ColdStakingController : Controller
    {
        ...
        public ColdStakingManager ColdStakingManager { get; }

        /// <summary>
        ///     Gets general information related to cold staking.
        /// </summary>
        /// <param name="request">
        ///     A <see cref="GetColdStakingInfoRequest" /> object containing the
        ///     parameters  required to obtain cold staking information.
        /// </param>
        ...
        public IActionResult GetColdStakingInfo([FromQuery] GetColdStakingInfoRequest request)
        {
            ...
            try
            {
                var model = this.ColdStakingManager.GetColdStakingInfo(request.WalletName);
        ...
        /// </summary>
        /// <remarks>
        ///     This method is used to create cold staking accounts on each machine/wallet, if required,
        ///     prior to calling <see cref="GetColdStakingAddress" />.
        /// </remarks>
        /// <param name="request">
        ///     A <see cref="CreateColdStakingAccountRequest" /> object containing the parameters
        ///     required for creating the cold staking account.
        /// </param>
        ...
        public IActionResult CreateColdStakingAccount([FromBody] CreateColdStakingAccountRequest request)
        {
            ...
            try
            {
                ...
                {
                    AccountName = this.ColdStakingManager.GetOrCreateColdStakingAccount(request.WalletName,
                        request.IsColdWalletAccount, request.WalletPassword).Name
                };
        ...
        /// </summary>
        /// <remarks>
        ///     This method is used to generate cold staking addresses on each machine/wallet
        ///     which will then be used with <see cref="SetupColdStaking(SetupColdStakingRequest)" />.
        /// </remarks>
        /// <param name="request">
        ///     A <see cref="GetColdStakingAddressRequest" /> object containing the parameters
        ///     required for generating the cold staking address.
        /// </param>
        ...
        /// </summary>
        /// <param name="request">
        ///     A <see cref="ColdStakingWithdrawalRequest" /> object containing the cold staking withdrawal
        ///     parameters.
        /// </param>
        ...
        public IActionResult ColdStakingWithdrawal([FromBody] ColdStakingWithdrawalRequest request)
        {
            ...
            try
            {
                ...
                var transaction = this.ColdStakingManager.GetColdStakingWithdrawalTransaction(
