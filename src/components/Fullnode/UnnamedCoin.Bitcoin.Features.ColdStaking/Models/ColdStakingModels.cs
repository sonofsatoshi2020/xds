...
namespace UnnamedCoin.Bitcoin.Features.ColdStaking.Models
{
    /// <summary>
    ...
    public class GetColdStakingInfoResponse
    {
        ...
        {
            return
                $"{nameof(this.ColdWalletAccountExists)}={this.ColdWalletAccountExists},{nameof(this.HotWalletAccountExists)}={this.HotWalletAccountExists}";
        }
    }
    ...
    public class CreateColdStakingAccountRequest
    {
        ...
        {
            return
                $"{nameof(this.WalletName)}={this.WalletName},{nameof(this.IsColdWalletAccount)}={this.IsColdWalletAccount}";
        }
    }
    ...
    public class GetColdStakingAddressRequest
    {
        ...
        {
            return
                $"{nameof(this.WalletName)}={this.WalletName},{nameof(this.IsColdWalletAddress)}={this.IsColdWalletAddress}";
        }
    }
    ...
    public class ColdStakingWithdrawalRequest
    {
        ...
        {
            return
                $"{nameof(this.ReceivingAddress)}={this.ReceivingAddress},{nameof(this.WalletName)}={this.WalletName},{nameof(this.Amount)}={this.Amount},{nameof(this.Fees)}={this.Fees}";
        }
    }
    ...
    public class SetupColdStakingRequest
    {
        ...
        {
            return
                $"{nameof(this.ColdWalletAddress)}={this.ColdWalletAddress},{nameof(this.HotWalletAddress)}={this.HotWalletAddress},{nameof(this.WalletName)}={this.WalletName},{nameof(this.WalletAccount)}={this.WalletAccount},{nameof(this.Amount)}={this.Amount},{nameof(this.Fees)}={this.Fees}";
        }
    }
