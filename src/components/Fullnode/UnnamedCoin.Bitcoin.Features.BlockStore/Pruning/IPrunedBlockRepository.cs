...
{
    /// <summary>
    ///     Prunes and compacts the block store database by deleting blocks lower than a certain height and recreating the
    ...
    public interface IPrunedBlockRepository
    {
        ...
        ///     <para>
        ///         The method first prunes by deleting blocks from the block store that are below the
        ///         <see cref="StoreSettings.AmountOfBlocksToKeep" /> from the store tip.
        ///     </para>
        ///     <para>
        ///         Once this is done the database is compacted by resaving the database file without the deleted references,
        ///         reducing the file size on disk.
        ///     </para>
        /// </summary>
