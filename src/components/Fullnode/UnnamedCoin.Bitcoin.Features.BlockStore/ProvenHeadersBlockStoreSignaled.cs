...
{
    /// <summary>
    ///     The goal of this behavior is to ensure that we have always a Proven Header for each block signaled, because our
    ///     node
    ...
    public class ProvenHeadersBlockStoreSignaled : BlockStoreSignaled
    {
        ...
        public ProvenHeadersBlockStoreSignaled(
            ...
            : base(blockStoreQueue, storeSettings, chainState, connection, nodeLifetime, loggerFactory,
                initialBlockDownloadState, signals, asyncProvider)
        {
