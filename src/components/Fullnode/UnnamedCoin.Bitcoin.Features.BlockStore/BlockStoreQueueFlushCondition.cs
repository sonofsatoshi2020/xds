...
namespace UnnamedCoin.Bitcoin.Features.BlockStore
{
    ...
    {
        readonly IInitialBlockDownloadState blockDownloadState;
        ...
        public bool ShouldFlush
        {
            get
            {
                ...
                var distanceFromConsensusTip =
                    this.chainState.ConsensusTip.Height - this.chainState.BlockStoreTip.Height;
