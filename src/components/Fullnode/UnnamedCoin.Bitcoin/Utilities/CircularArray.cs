...
namespace UnnamedCoin.Bitcoin.Utilities
{
    ...
    {
        /// <summary>
        ///     Circular array of items, which holds <see cref="Count" /> valid items, and can store up to
        ...
        /// <param name="preinitializeItems">
        ///     If set to <c>true</c>, all items in the array will be initialized using their default constructor.
        ///     This can be used to prevent further allocations when the structure is used.
        /// </param>
        ...
        /// </summary>
        /// <param name="i">
        ///     Zero-based index of the item to access. Index must be an integer between 0 and <see cref="Capacity" />
        ///     - 1.
        /// </param>
