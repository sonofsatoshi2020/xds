...
namespace UnnamedCoin.Bitcoin.Utilities
{
    ...
    /// <remarks>
    ///     Implementation doesn't iterate through the whole collection of samples when average value is being calculated which
    ///     makes this component more optimal
    ...
    public class AverageCalculator
    {
        ...
        public void SetMaxSamples(int maxSamples)
        {
            ...
            foreach (var item in this.samples.Skip(skip))
                resized.Add(item, out var unused);
        ...
        {
            var oldSampleExisted = this.samples.Add(sample, out var removedSample);
