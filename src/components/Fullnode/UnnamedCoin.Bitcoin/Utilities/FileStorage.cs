...
namespace UnnamedCoin.Bitcoin.Utilities
{
    public class FileStorageOption
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether a null value should be serialized in the output file. Default value is
        ///     true.
        /// </summary>
        /// <value>
        ...
        internal JsonSerializerSettings GetSerializationSettings()
        {
            ...
            settings.NullValueHandling =
                this.SerializeNullValues ? NullValueHandling.Include : NullValueHandling.Ignore;
    ...
    public sealed class FileStorage<T> where T : new()
    {
        ...
        public void SaveToFile(T toSave, string fileName, FileStorageOption options = null)
        {
            ...
            var newFilePath = $"{filePath}.{uniqueId}.new";
            var tempFilePath = $"{filePath}.{uniqueId}.temp";

            File.WriteAllText(newFilePath,
                JsonConvert.SerializeObject(toSave, options.Indent ? Formatting.Indented : Formatting.None,
                    options.GetSerializationSettings()));
            ...
            if (!File.Exists(filePath))
            {
                ...
                if (options.SaveBackupFile) File.Copy(filePath, $"{filePath}.bak", true);
        ...
        public IEnumerable<string> GetFilesNames(string fileExtension)
        {
            ...
            var filesPaths = GetFilesPaths(fileExtension);
        ...
        public IEnumerable<T> LoadByFileExtension(string fileExtension)
        {
            ...
            foreach (var filePath in filesPaths)
            {
                ...
                var loadedFile = LoadByFileName(fileName);
