...
namespace UnnamedCoin.Bitcoin.Utilities
{
    ...
    {
        readonly CancellationTokenSource startedSource = new CancellationTokenSource();

        readonly CancellationTokenSource stoppedSource = new CancellationTokenSource();

        readonly CancellationTokenSource stoppingSource = new CancellationTokenSource();
