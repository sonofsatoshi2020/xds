...
namespace UnnamedCoin.Bitcoin.Utilities.Extensions
{
    ...
    public static class BlockExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This implements the <c>weight = (stripped_size * 4) + witness_size</c> formula, using only serialization with and
        ///     without witness data.
        ///     As witness_size is equal to total_size - stripped_size, this formula is identical to:
        ///     <c>weight = (stripped_size * 3) + total_size</c>.
        /// </remarks>
        ...
        {
            return block.GetSize(TransactionOptions.None, consensus.ConsensusFactory) *
                   (consensus.Options.WitnessScaleFactor - 1) +
                   block.GetSize(TransactionOptions.Witness, consensus.ConsensusFactory);
        }
        ...
        public static int GetSize(this IBitcoinSerializable data, TransactionOptions options,
