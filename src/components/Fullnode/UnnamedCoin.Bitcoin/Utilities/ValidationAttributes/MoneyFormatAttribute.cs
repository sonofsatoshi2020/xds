...
namespace UnnamedCoin.Bitcoin.Utilities.ValidationAttributes
{
    /// <summary>
    ...
    public class MoneyFormatAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (this.isRequired && value == null) return false;

            // Check if the value is not required and not provided.
            if (!this.isRequired && value == null) return true;

            return Money.TryParse(value.ToString(), out var money);
        }
    }
}