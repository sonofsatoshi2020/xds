...
namespace UnnamedCoin.Bitcoin.Utilities
{
    public class UnspentOutputs : IBitcoinSerializable
    {
        ...
        public UnspentOutputs(uint height, Transaction tx)
        {
            ...
            if (tx is IPosTransactionWithTime posTrx) this.Time = posTrx.Time;
        }
        ...
        public bool IsPrunable
        {
            get
            {
                return this.Outputs.All(o => o == null ||
                                             o.ScriptPubKey.Length > 0 && o.ScriptPubKey.ToBytes(true)[0] ==
        ...
        public bool IsFull
        {
            get { return this.Outputs.All(o => o != null); }
        }

        public int UnspentCount
        {
            get { return this.Outputs.Count(o => o != null); }
        }
        ...
        void SetCoins(Coins coins)
        {
            ...
            for (uint i = 0; i < this.Outputs.Length; i++) this.Outputs[i] = coins.TryGetOutput(i);
        }
        ...
        public Coins ToCoins()
        {
            ...
            foreach (var output in this.Outputs) coins.Outputs.Add(output == null ? Coins.NullTxOut : output);
        ...
        public override string ToString()
        {
            ...
            foreach (var output in this.Outputs.Take(5))
