...
namespace UnnamedCoin.Bitcoin.Base.Deployments
{
    public class DeploymentFlags
    {
            ...
            ChainIndexer chainIndexer)
        {
            ...
            if (nextBlock.Height >= chainparams.BuriedDeployments[BuriedDeployments.BIP34]) this.EnforceBIP34 = true;
        }
        ...
        public static bool EnforceBIP30ForBlock(ChainedHeader nextBlock)
        {
            ...
            var enforceBIP30 =
                nextBlock.HashBlock == null // Enforce on CreateNewBlock invocations which don't have a hash.
                || !(nextBlock.Height == 91842 && nextBlock.HashBlock ==
                     new uint256("00000000000a4d0a398161ffc163c503763b1f4360639393e0e4c8e300e0caec")
                     || nextBlock.Height == 91880 && nextBlock.HashBlock ==
                     new uint256("00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721"));
