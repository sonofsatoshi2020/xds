...
namespace UnnamedCoin.Bitcoin.Base
{
    ...
    public interface IInvalidBlockHashStore
    {
        ...
        /// <param name="rejectedUntil">
        ///     Time in UTC after which the block is no longer considered as invalid, or <c>null</c> if the
        ///     block is to be considered invalid forever.
        /// </param>
    ...
    public class InvalidBlockHashStore : IInvalidBlockHashStore
    {
        ...
        readonly Dictionary<uint256, DateTime?> invalidBlockHashesExpirations;

        /// <summary>
        ///     Lock object to protect access to <see cref="invalidBlockHashesExpirations" /> and
        ///     <see cref="orderedHashList" />.
        /// </summary>
        readonly object lockObject = new object();

        /// <summary>
        ///     Circular array of block header hash entries to allow quick removal of the oldest entry once the capacity is
        ///     reached.
        /// </summary>
        /// <remarks>
        ///     All access to this object has to be protected by <see cref="lockObject" />.
        /// </remarks>
        readonly CircularArray<uint256> orderedHashList;
        ...
        public void MarkInvalid(uint256 hashBlock, DateTime? rejectedUntil = null)
        {
            ...
            {
                DateTime? expirationTime;
                var existsAlready = this.invalidBlockHashesExpirations.TryGetValue(hashBlock, out expirationTime);
                if (existsAlready)
                {
                    ...
                    var strongerBan = rejectedUntil == null ||
                                      expirationTime != null && rejectedUntil.Value > expirationTime.Value;
