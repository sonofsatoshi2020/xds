...
namespace UnnamedCoin.Bitcoin.Consensus.PerformanceCounters.Rules
{
    ...
    public class ConsensusRulesPerformanceCounter
    {
        ...
        readonly IList<RuleItem> registeredRules;

        /// <summary>Snapshot that is currently being populated.</summary>
        ConsensusRulesPerformanceSnapshot currentSnapshot;
        ...
        void RegisterRulesCollection(IEnumerable<IConsensusRuleBase> rules, RuleType rulesType)
        {
        ...
        public IDisposable MeasureRuleExecutionTime(IConsensusRuleBase rule)
        {
            ...
            {
                var performance = this.currentSnapshot.PerformanceInfo[rule];
