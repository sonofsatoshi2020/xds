...
{
    /// <summary>
    ///     A context that is used by consensus that is required for validation, in case validation failed the
    ///     <see cref="ValidationContext.Error" /> property will be set.
    ...
    public class ValidationContext
    {
        ...
        /// <summary>
        ///     If the block validation failed with a <see cref="ConsensusError" /> that is considered malicious the peer will get
        ///     banned.
        ...
        ///     Setting this value to be <see cref="BanDurationDefaultBan" /> will default to
        ///     <see cref="ConnectionManagerSettings.BanTimeSeconds" />.
        /// </remarks>
