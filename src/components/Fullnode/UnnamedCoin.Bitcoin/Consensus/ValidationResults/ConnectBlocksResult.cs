...
namespace UnnamedCoin.Bitcoin.Consensus.ValidationResults
{
    /// <summary>
    ///     Information related to the block full validation process.
    /// </summary>
    class ConnectBlocksResult : ValidationResult
    {
        ...
        public override string ToString()
        {
            ...
            return
                $"{nameof(this.Succeeded)}={this.Succeeded},{nameof(this.ConsensusTipChanged)}={this.ConsensusTipChanged},{nameof(this.PeersToBan)}.{nameof(this.PeersToBan.Count)}={this.PeersToBan.Count},{nameof(this.BanReason)}={this.BanReason},{nameof(this.BanDurationSeconds)}={this.BanDurationSeconds}";
        }
    }
}