...
namespace UnnamedCoin.Bitcoin.Consensus.Rules
{
    public class ConsensusRulesContainer
    {
        ...
        {
            this.HeaderValidationRules =
                headerValidationConsensusRules.OfType<HeaderValidationConsensusRule>().ToList();
            this.IntegrityValidationRules =
                integrityValidationConsensusRules.OfType<IntegrityValidationConsensusRule>().ToList();
            this.PartialValidationRules =
                partialValidationConsensusRules.OfType<PartialValidationConsensusRule>().ToList();
