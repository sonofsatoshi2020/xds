...
namespace UnnamedCoin.Bitcoin.Consensus
{
    ...
    public interface IConsensusManager : IDisposable
    {
        ...
        /// <summary>
        ///     Set the tip of <see cref="ConsensusManager" />, if the given <paramref name="chainTip" /> is not equal to
        ///     <see cref="Tip" />
        ///     then rewind consensus until a common header is found.
        /// </summary>
        /// <param name="chainTip">
        ///     Last common header between chain repository and block store if it's available,
        ///     if the store is not available it is the chain repository tip.
        /// </param>
        ...
        ConnectNewHeadersResult HeadersPresented(INetworkPeer peer, List<BlockHeader> headers,
        ...
        /// </summary>
        /// <remarks>
        ///     First we check if the block exists in chained header tree, then it check the block store and if it wasn't found
        ///     there the block will be scheduled for download.
        ///     Given callback is called when the block is obtained. If obtaining the block fails the callback will be called with
        ///     <c>null</c>.
        /// </remarks>
    ...
    /// <summary>
    ///     A delegate that is used to send callbacks when a block is downloaded from the queued requests to downloading
    ///     blocks.
    /// </summary>
