...
namespace UnnamedCoin.Bitcoin.Configuration.Settings
{
    ...
    public class ConsensusSettings
    {
        ...
        public ConsensusSettings(NodeSettings nodeSettings)
        {
            ...
            this.UseCheckpoints = config.GetOrDefault("checkpoints", true, this.logger);
            this.BlockAssumedValid = config.GetOrDefault("assumevalid",
                nodeSettings.Network.Consensus.DefaultAssumeValid, this.logger);
        ...
        /// </summary>
        public int MaxBlockMemoryInMB { get; }
        ...
        public static void PrintHelp(Network network)
        {
            ...
            builder.AppendLine(
                $"-assumevalid=<hex>        If this block is in the chain assume that it and its ancestors are valid and potentially skip their script verification (0 to verify all). Defaults to {network.Consensus.DefaultAssumeValid}.");
        ...
        public static void BuildDefaultConfigurationFile(StringBuilder builder, Network network)
        {
            ...
            builder.AppendLine(
                $"#If this block is in the chain assume that it and its ancestors are valid and potentially skip their script verification (0 to verify all). Defaults to {network.Consensus.DefaultAssumeValid}.");
