...
namespace UnnamedCoin.Bitcoin.P2P.Protocol
{
    ...
    public class MessageProducerRegistration<T> : IDisposable
    {
        ...
        readonly IMessageListener<T> listener;

        /// <summary>Producer of messages.</summary>
        readonly MessageProducer<T> producer;
    ...
    public class MessageProducer<T>
    {
        ...
        readonly ConcurrentHashSet<IMessageListener<T>> listeners;
        ...
        public void PushMessage(T message)
        {
            ...
            foreach (var listener in this.listeners) listener.PushMessage(message);
        }
    }
}