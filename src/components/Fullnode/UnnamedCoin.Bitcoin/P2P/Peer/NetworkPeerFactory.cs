...
namespace UnnamedCoin.Bitcoin.P2P.Peer
{
    ...
    public interface INetworkPeerFactory
    {
        ...
        /// <param name="networkPeerDisposer">
        ///     Maintains a list of connected peers and ensures their proper disposal. Or <c>null</c>
        ///     if case disposal should be handled from user code.
        /// </param>
        ...
        ///     <see cref="VersionPayload.Relay" /> for more information.
        /// </param>
        ...
        Task<INetworkPeer> CreateConnectedNetworkPeerAsync(string endPoint,
            ProtocolVersion myVersion = ProtocolVersion.PROTOCOL_VERSION, bool isRelay = true,
            CancellationToken cancellation = default, NetworkPeerDisposer networkPeerDisposer = null);
        ...
        ///     Parameters specifying how the connection with the counterparty should be established, or
        ///     <c>null</c> to use default parameters.
        /// </param>
        /// <param name="networkPeerDisposer">
        ///     Maintains a list of connected peers and ensures their proper disposal. Or <c>null</c>
        ///     if case disposal should be handled from user code.
        /// </param>
        /// <returns>Network peer connected to the specified counterparty.</returns>
        Task<INetworkPeer> CreateConnectedNetworkPeerAsync(IPEndPoint peerEndPoint,
            NetworkPeerConnectionParameters parameters = null, NetworkPeerDisposer networkPeerDisposer = null);
        ...
        NetworkPeerServer CreateNetworkPeerServer(IPEndPoint localEndPoint, IPEndPoint externalEndPoint,
        ...
        NetworkPeerConnection CreateNetworkPeerConnection(INetworkPeer peer, TcpClient client,
            ProcessMessageAsync<IncomingMessage> processMessageAsync);

        /// <summary>
        ///     Registers a callback that will be passed to all created peers. It gets called prior to sending messages to the
        ///     peer.
        /// </summary>
    ...
    public class NetworkPeerFactory : INetworkPeerFactory
    {
        ...
        ///     be called.
        /// </summary>
        Action<IPEndPoint, Payload> onSendingMessage;
        ...
        /// <inheritdoc />
        public NetworkPeerServer CreateNetworkPeerServer(IPEndPoint localEndPoint, IPEndPoint externalEndPoint,
            ProtocolVersion version = ProtocolVersion.PROTOCOL_VERSION)
        {
            Guard.NotNull(localEndPoint, nameof(localEndPoint));
            Guard.NotNull(externalEndPoint, nameof(externalEndPoint));

            return new NetworkPeerServer(this.network, localEndPoint, externalEndPoint, version, this.loggerFactory,
                this, this.initialBlockDownloadState, this.connectionManagerSettings, this.asyncProvider);
        }

        /// <inheritdoc />
        public NetworkPeerConnection CreateNetworkPeerConnection(INetworkPeer peer, TcpClient client,
            ProcessMessageAsync<IncomingMessage> processMessageAsync)
        {
            ...
            var id = Interlocked.Increment(ref this.lastClientId);
            return new NetworkPeerConnection(this.network, peer, client, id, processMessageAsync, this.dateTimeProvider,
                this.loggerFactory, this.payloadProvider, this.asyncProvider);
        }
