...
namespace UnnamedCoin.Bitcoin.P2P.Peer
{
    ...
    ///     <para>
    ///         The network peer is connected either inbound, if it was the counterparty that established
    ...
    public interface INetworkPeer : IDisposable
    {
        ...
        /// <summary>
        ///     Difference between the local clock and the clock that peer claims, or <c>null</c> if this information has not
        ///     been initialized yet.
        /// </summary>
        TimeSpan? TimeOffset { get; }

        /// <summary>
        ///     Component representing the network connection to the peer that is responsible for sending and receiving
        ///     messages.
        /// </summary>
        ...
        /// <summary>
        ///     The negotiated protocol version (minimum of supported version between <see cref="MyVersion" /> and the
        ///     <see cref="PeerVersion" />).
        /// </summary>
        ProtocolVersion Version { get; }

        /// <summary>
        ///     <c>true</c> if the connection to the peer is considered active, <c>false</c> otherwise, including any case of
        ///     error.
        /// </summary>
        ...
        /// <summary>
        ///     Connects the node to an outbound peer using already initialized information about the peer and starts receiving
        ///     messages in a separate task.
        /// </summary>
        ...
        ///     Thrown when the peer has been disconnected or the cancellation token has
        ///     been cancelled.
        /// </exception>
        ...
        ///     been cancelled.
        /// </exception>
        Task SendMessageAsync(Payload payload, CancellationToken cancellation = default);

        /// <summary>
        ///     Exchanges "version" and "verack" messages with the peer.
        ///     <para>
        ///         Both parties have to send their "version" messages to the other party
        ///         as well as to acknowledge that they are happy with the other party's "version" information.
        ///     </para>
        /// </summary>
        ...
        Task VersionHandshakeAsync(CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ProtocolException">Thrown when the peer rejected our "version" message.</exception>
        /// <exception cref="OperationCanceledException">Thrown during the shutdown or when the peer disconnects.</exception>
        Task RespondToHandShakeAsync(CancellationToken cancellationToken = default);
        ...
        ///     Exception because of which the disconnection happened, or <c>null</c> if there were no
        ///     exception.
        /// </param>
