...
namespace UnnamedCoin.Bitcoin.P2P.Peer
{
    public class NetworkPeerConnectionParameters
    {
        public NetworkPeerConnectionParameters()
        {
            ...
            this.ConnectCancellation = default;
        ...
        public NetworkPeerConnectionParameters SetFrom(NetworkPeerConnectionParameters other)
        {
            ...
            foreach (var behavior in other.TemplateBehaviors) this.TemplateBehaviors.Add(behavior.Clone());
        ...
        public VersionPayload CreateVersion(IPEndPoint externalAddressEndPoint, IPEndPoint peerAddress, Network network,
