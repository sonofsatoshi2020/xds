...
namespace UnnamedCoin.Bitcoin.P2P
{
    ...
    public interface ISelfEndpointTracker
    {
        ...
        /// <param name="suppliedEndPointIsFinal">
        ///     Whether the <paramref name="ipEndPoint" /> supplied should be marked final on the
        ///     endpoint tracker.
        /// </param>
        /// <param name="ipEndPointPeerScore">Peer score of the <paramref name="ipEndPoint" /> supplied. Default value of 1.</param>
        void UpdateAndAssignMyExternalAddress(IPEndPoint ipEndPoint, bool suppliedEndPointIsFinal,
            int ipEndPointPeerScore = 1);
