...
namespace UnnamedCoin.Bitcoin.P2P
{
    ...
    public sealed class PeerAddress
    {
        ...
        ///     <para>
        ///         This gets reset when a connection was successful.
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         This gets reset when a handshake was successful.
        ///     </para>
        /// </summary>
        [JsonIgnore]
        ...
        ///             <item>
        ///                 The peer has been attempted more than the maximum amount of attempts (<see cref="AttemptThreshold" />
        ///                 .
        ///             </item>
        ///         </list>
        ///     </para>
        ...
        public bool CanResetAttempts =>
            this.Attempted &&
            this.ConnectionAttempts >= AttemptThreshold &&
            this.LastAttempt < DateTime.UtcNow.AddHours(-AttemptResetThresholdHours);
        ...
        /// <summary>
        ///     Sets the <see cref="LastConnectionSuccess" />, <see cref="addressTime" /> and <see cref="NetworkAddress.Time" />
        ///     properties.
        ///     <para>
        ...
        /// <summary>
        ///     Un-bans a peer by resetting the <see cref="BanReason" />, <see cref="BanScore" />, <see cref="BanTimeStamp" /> and
        ///     <see cref="BanUntil" /> properties.
        /// </summary>
        public void UnBan()
        {
            this.BanReason = null;
