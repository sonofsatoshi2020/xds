...
namespace UnnamedCoin.Bitcoin.P2P
{
    ...
    public interface IPeerAddressManager : IDisposable
    {
        ...
        ///     <para>
        ///         Increments <see cref="PeerAddress.ConnectionAttempts" /> of the peer as well as the
        ///         <see cref="PeerAddress.LastConnectionSuccess" />
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         Resets the <see cref="PeerAddress.ConnectionAttempts" /> and <see cref="PeerAddress.LastAttempt" /> of the
        ///         peer.
