...
namespace UnnamedCoin.Bitcoin.P2P
{
    ...
    public class SelfEndpointTracker : ISelfEndpointTracker
    {
        ...
        readonly ConcurrentHashSet<IPEndPoint> knownSelfEndpoints = new ConcurrentHashSet<IPEndPoint>();

        /// <summary>
        ///     Protects access to <see cref="MyExternalAddress" />, <see cref="MyExternalAddressPeerScore" /> and
        ///     <see cref="IsMyExternalAddressFinal" />.
        /// </summary>
