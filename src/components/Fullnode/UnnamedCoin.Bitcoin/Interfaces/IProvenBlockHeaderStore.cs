...
namespace UnnamedCoin.Bitcoin.Interfaces
{
    ...
    {
        /// <summary>
        ///     Initializes the <see cref="IProvenBlockHeaderStore" /> at the last common header between
        ///     <paramref name="chainedHeader" /> and <see cref="IProvenBlockHeaderProvider.TipHashHeight" />.
        /// </summary>
        /// <param name="chainedHeader">
        ///     <see cref="ChainedHeader" /> consensus tip after
        ///     <see cref="Bitcoin.Consensus.IConsensusManager" /> initialization.
        /// </param>
        ...
        /// <summary>
        ///     Saves pending <see cref="ProvenBlockHeader" /> items to the <see cref="IProvenBlockHeaderRepository" />, then
        ///     removes the items from the pending batch.
        /// </summary>
        Task SaveAsync();
    }
}