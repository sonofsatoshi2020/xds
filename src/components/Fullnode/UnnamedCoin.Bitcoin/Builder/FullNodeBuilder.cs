...
namespace UnnamedCoin.Bitcoin.Builder
{
    /// <summary>
    ...
    public class FullNodeBuilder : IFullNodeBuilder
    {
        ...
        readonly List<Action<IServiceProvider>> configureDelegates;

        /// <summary>List of delegates that add services to the builder.</summary>
        readonly List<Action<IServiceCollection>> configureServicesDelegates;

        /// <summary>List of delegates that add features to the collection.</summary>
        readonly List<Action<IFeatureCollection>> featuresRegistrationDelegates;
        ...
        /// <summary>
        ///     Initializes an instance of the object using specific NodeSettings instance and configuration delegates and
        ...
        internal FullNodeBuilder(NodeSettings nodeSettings, List<Action<IServiceCollection>> configureServicesDelegates,
        ...
        /// <param name="featuresRegistrationDelegates">List of delegates that add features to the collection.</param>
        /// <param name="features">Collection of features to be available to and/or used by the node.</param>
        internal FullNodeBuilder(List<Action<IServiceCollection>> configureServicesDelegates,
            List<Action<IServiceProvider>> configureDelegates,
            List<Action<IFeatureCollection>> featuresRegistrationDelegates, IFeatureCollection features)
        {
        ...
        IServiceCollection BuildServices()
        {
            ...
            foreach (var featureRegistration in this.Features.FeatureRegistrations)
            {
                ...
                {
                    this.NodeSettings.Logger.LogCritical(
