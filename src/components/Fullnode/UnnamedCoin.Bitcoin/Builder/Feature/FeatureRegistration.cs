...
namespace UnnamedCoin.Bitcoin.Builder.Feature
{
        ...
        where TImplementation : class, IFullNodeFeature
    {
        ...
        public List<Action<IServiceCollection>> ConfigureServicesDelegates { get; }
        ...
        public IFeatureRegistration DependOn<TFeatureImplementation>()
            where TFeatureImplementation : class, IFullNodeFeature
        {
        ...
        /// </param>
        void FeatureStartup(IServiceCollection serviceCollection, Type startupType)
        {
