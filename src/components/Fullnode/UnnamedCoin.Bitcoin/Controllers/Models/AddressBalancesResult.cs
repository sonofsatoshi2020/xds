...
namespace UnnamedCoin.Bitcoin.Controllers.Models
{
    ...
    {
        [BsonId] public string Address { get; set; }
    ...
    public class AddressBalanceChange
    {
        ...
        {
            return
                $"{nameof(this.Deposited)}:{this.Deposited}, {nameof(this.Satoshi)}:{this.Satoshi}, {nameof(this.BalanceChangedHeight)}:{this.BalanceChangedHeight}";
        }
    }
