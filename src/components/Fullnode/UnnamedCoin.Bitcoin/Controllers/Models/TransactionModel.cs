...
namespace UnnamedCoin.Bitcoin.Controllers.Models
{
    ...
    public class TransactionVerboseModel : TransactionModel
    {
        ...
        public TransactionVerboseModel(Transaction trx, Network network, ChainedHeader block = null,
            ChainedHeader tip = null) : base(trx)
        {
            if (trx != null)
            {
                ...
                this.VSize = trx.HasWitness
                    ? trx.GetVirtualSize(network.Consensus.Options.WitnessScaleFactor)
                    : trx.GetSerializedSize();
                ...
                this.Weight = this.VSize * network.Consensus.Options.WitnessScaleFactor -
                              (network.Consensus.Options.WitnessScaleFactor - 1);
    ...
    public class Vin
    {
        ...
        ///     <see cref="https://bitcoin.org/en/developer-guide#locktime-and-sequence-number" />
        /// </summary>
    ...
    public class Script
    {
        ...
        /// <summary>
        ///     Initializes a transaction <see cref="Script" />, which contains the assembly and a hexadecimal representation of
        ///     the script.
        /// </summary>
