...
namespace UnnamedCoin.Bitcoin.AsyncWork
{
    ...
    {
        /// <summary>
        ///     temporary hack to expose signals to most of the components (every component currently using asyncprovider), while
        ///     we decide if we should introduce a component
        ///     that references common services/components used almost in every other features.
        ///     This has to be removed once the "ICoreComponents" has been created and injected everywhere or when we decide that
        ///     we still have to inject single services where needed.
        ///     In favor of ICoreComponents, everytime we need a new core service around, we spend lot of time refactoring every
        ///     test and many legacy component.
        ...
        /// <summary>
        ///     Creates a delegate that is called asynchronously in the background whenever a new <typeparamref name="T" /> is
        ///     queued.
        /// </summary>
        ...
        /// <returns>
        ///     <c>true</c> if an <see cref="IAsyncDelegateDequeuer{T}" /> with the specified name is currently running, otherwise,
        ///     <c>false</c>.
        /// </returns>
        /// <remarks>
        ///     Names are not unique, consider adding prefixes to names when <see cref="IAsyncDelegateDequeuer{T}" /> are transient
        ///     and does not act like singletons. This method is mostly used for tests.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        ///     Names are not guaranteed to be unique, consider adding prefixes to names when <see cref="IAsyncLoop" /> are
        ///     transient and does not act like singletons. This method is mostly used for tests.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        ///     Names are not guaranteed to be unique, consider adding prefixes to names when loops are transient and does not act
        ///     like singletons.
