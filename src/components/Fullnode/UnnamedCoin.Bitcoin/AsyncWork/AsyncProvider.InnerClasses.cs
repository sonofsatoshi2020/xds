...
namespace UnnamedCoin.Bitcoin.AsyncWork
{
    public partial class AsyncProvider : IAsyncProvider
    {
        ...
        /// </summary>
        interface IAsyncTaskInfoSetter
        {
        ...
        internal class AsyncTaskInfo : IAsyncTaskInfoSetter
        {
            ...
            /// <param name="isDelegateWorker">
            ///     if set to <c>true</c> the information represents an
            ///     <see cref="IAsyncDelegateDequeuer" />, otherwise an <see cref="IAsyncLoop" />.
            /// </param>
            ...
            TaskStatus IAsyncTaskInfoSetter.Status
            {
                set => this.Status = value;
            }

            Exception IAsyncTaskInfoSetter.Exception
            {
