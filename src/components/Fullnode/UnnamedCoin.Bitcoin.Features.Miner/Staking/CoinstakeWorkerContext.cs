...
namespace UnnamedCoin.Bitcoin.Features.Miner.Staking
{
    /// <summary>
    ...
    public class CoinstakeWorkerContext
    {
        ...
        /// <summary>
        ///     Result shared by all workers. A structure that determines the kernel founder and the kernel UTXO that
        ///     satisfies the target difficulty.
        /// </summary>
