...
namespace UnnamedCoin.Bitcoin.Features.Miner.Controllers
{
    ...
    public class StakingRpcController : FeatureController
    {
        ...
        public StakingRpcController(IFullNode fullNode, ILoggerFactory loggerFactory, IWalletManager walletManager,
            IPosMinting posMinting = null) : base(fullNode)
        {
        ...
        public GetStakingInfoModel GetStakingInfo(bool isJsonFormat = true)
        {
            ...
            var model = this.posMinting != null ? this.posMinting.GetGetStakingInfoModel() : new GetStakingInfoModel();
