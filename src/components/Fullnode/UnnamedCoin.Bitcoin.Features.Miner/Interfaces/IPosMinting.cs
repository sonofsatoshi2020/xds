...
using UnnamedCoin.Bitcoin.Features.Miner.Staking;
using UnnamedCoin.Bitcoin.Mining;

namespace UnnamedCoin.Bitcoin.Features.Miner.Interfaces
{
    /// <summary>
    ///     <see cref="PosMinting" /> is used in order to generate new blocks. It involves a sort of lottery, similar to
    ///     proof-of-work,
    ...
    public interface IPosMinting
    {
        ...
        ///     Length of an unexplored block time space in seconds. It only makes sense to look for a
        ...
        /// <param name="coinstakeContext">
        ///     Information about coinstake transaction and its private key that is to be filled when
        ///     the kernel is found.
        /// </param>
        /// <returns><c>true</c> if the function succeeds, <c>false</c> otherwise.</returns>
        Task<bool> CreateCoinstakeAsync(List<UtxoStakeDescription> utxoStakeDescriptions, BlockTemplate blockTemplate,
            ChainedHeader chainTip, long searchInterval, long fees, CoinstakeContext coinstakeContext);
        ...
        ///     <see
        ///         cref="https://github.com/stratisproject/stratisX/blob/47851b7337f528f52ec20e86dca7dcead8191cf5/src/rpcblockchain.cpp#L16" />
        ///     .
        /// </remarks>
        ...
        ///         <see
        ///             cref="https://github.com/stratisproject/stratisX/blob/47851b7337f528f52ec20e86dca7dcead8191cf5/src/rpcblockchain.cpp#L74" />
        ///         .
        ///     </para>
        /// </remarks>
