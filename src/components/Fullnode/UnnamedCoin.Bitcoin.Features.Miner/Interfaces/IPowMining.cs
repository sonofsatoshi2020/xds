...
namespace UnnamedCoin.Bitcoin.Features.Miner.Interfaces
{
    public interface IPowMining
    {
        ...
        /// <param name="generate">
        ///     Number of blocks to generate. It is possible that less than the required number of blocks will
        ///     be mined.
        /// </param>
        /// <param name="maxTries">
        ///     Maximum number of attempts the miner will calculate PoW hash in order to find suitable ones to
        ...
        /// <summary>
        ///     Increments or resets the extra nonce based on the previous hash block value on on the pow miner and the passed
        ///     nExtraNonce.
        /// </summary>
