...
namespace UnnamedCoin.Bitcoin.Features.Wallet.Interfaces
{
    ...
    public interface IWalletManager
    {
        ...
        /// </summary>
        /// <returns>A collection of spendable outputs</returns>
        IEnumerable<UnspentOutputReference> GetSpendableTransactionsInWalletForStaking(string walletName,
            int confirmations = 0);
        ...
        IEnumerable<UnspentOutputReference> GetUnspentTransactionsInWallet(string walletName, int confirmations,
        ...
        IEnumerable<UnspentOutputReference> GetSpendableTransactionsInAccount(
        ...
        Wallet RecoverWallet(string password, string name, string mnemonic, DateTime creationTime,
            string passphrase = null, int? coinType = null);
        ...
        ///     The height of the block this transaction came from. Null if it was not a transaction included
        ///     in a block.
        /// </param>
        ...
        HashSet<(uint256, DateTimeOffset)> RemoveTransactionsByIds(string walletName,
