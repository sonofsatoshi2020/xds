...
namespace UnnamedCoin.Bitcoin.Features.Wallet.Interfaces
{
    public interface IWalletTransactionHandler
    {
        ...
        ///     The inputs added may be signed depending on whether a <see cref="TransactionBuildContext.WalletPassword" /> is
        ///     passed.
        ...
        /// <param name="feeType">
        ///     The type of fee used to calculate the maximum amount the user can spend. The higher the fee, the
        ///     smaller this amount will be.
        /// </param>
        /// <param name="allowUnconfirmed">
        ///     <c>true</c> to include unconfirmed transactions in the calculation, <c>false</c>
        ///     otherwise.
        /// </param>
        /// <returns>The maximum amount the user can spend in a single transaction, along with the fee required.</returns>
        (Money maximumSpendableAmount, Money Fee) GetMaximumSpendableAmount(WalletAccountReference accountReference,
