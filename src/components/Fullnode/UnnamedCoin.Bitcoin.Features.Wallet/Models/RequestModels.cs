...
using UnnamedCoin.Bitcoin.Features.Wallet.Validations;
using UnnamedCoin.Bitcoin.Utilities.ValidationAttributes;
...
namespace UnnamedCoin.Bitcoin.Features.Wallet.Models
{
    ...
    public class WalletRecoveryRequest : RequestModel
    {
        ...
        /// </summary>
        /// <remarks>
        ///     If the wallet was created before <see cref="Passphrase" /> was available as a parameter, set the passphrase to be
    ...
    public class TxFeeEstimateRequest : RequestModel
    {
        ...
        /// </summary>
        [MoneyFormat(false, ErrorMessage = "The op return amount is not in the correct format.")]
        ...
        ///     the default behaviour from the <see cref="WalletTransactionHandler" /> will be used to determine the change
        ///     address.
        /// </summary>
        [IsBitcoinAddress(Required = false)]
    ...
    public class BuildTransactionRequest : TxFeeEstimateRequest, IValidatableObject
    {
        ...
        /// </summary>
        [MoneyFormat(false, ErrorMessage = "The fee is not in the correct format.")]
    ...
    public class RemoveTransactionsModel : RequestModel, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (!this.DeleteAll && (this.TransactionsIds == null || !this.TransactionsIds.Any()) &&
                this.FromDate == default)
                yield return new ValidationResult(
            ...
            if (this.DeleteAll && this.TransactionsIds != null
                || this.DeleteAll && this.FromDate != default
                || this.TransactionsIds != null && this.FromDate != default)
                yield return new ValidationResult(
    ...
    public class SplitCoinsRequest : RequestModel
    {
        ...
        [Required] public int UtxosCount { get; set; }
    }
    ...
    public sealed class DistributeUtxosRequest : RequestModel, IValidatableObject
    {
        ...
        [DefaultValue(false)] public bool UseUniqueAddressPerUtxo { get; set; }

        [DefaultValue(true)] public bool ReuseAddresses { get; set; }

        [DefaultValue(false)] public bool UseChangeAddresses { get; set; }

        [Required] public int UtxosCount { get; set; }

        [Required] public int UtxoPerTransaction { get; set; }

        [DefaultValue(0)] public int TimestampDifferenceBetweenTransactions { get; set; }
        ...
        [Required] public bool DryRun { get; set; }
