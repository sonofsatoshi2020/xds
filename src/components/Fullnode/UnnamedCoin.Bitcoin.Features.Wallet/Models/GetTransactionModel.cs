...
namespace UnnamedCoin.Bitcoin.Features.Wallet.Models
{
    ...
    public class GetTransactionDetailsModel
    {
        ...
        ///     For 'send' it's the external destination address it was sent to, for 'receive' it's the wallet address it was
        ///     received into.
        /// </summary>
    ...
    public enum GetTransactionDetailsCategoryModel
    {
        ...
        /// </summary>
        [EnumMember(Value = "generate")] Generate,

        /// <summary>
        ///     Immature coinbase or coinstake transactions.
        /// </summary>
        [EnumMember(Value = "immature")] Immature,

        /// <summary>
        ///     Orphaned coinbase or coinstake transactions received.
        /// </summary>
        [EnumMember(Value = "orphan")] Orphan
    }
}