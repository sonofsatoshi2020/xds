...
namespace UnnamedCoin.Bitcoin.Features.RPC
{
    ...
    public class RPCJsonOutputFormatter : TextOutputFormatter, IRPCJsonOutputFormatter
    {
        ...
        ///     <see cref="M:Microsoft.AspNetCore.Mvc.Formatters.JsonSerializerSettingsProvider.CreateSerializerSettings" />
        ///     initially returned.
        /// </param>
        ...
        /// <summary>
        ///     Gets the <see cref="T:Newtonsoft.Json.JsonSerializerSettings" /> used to configure the
