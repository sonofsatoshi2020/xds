...
namespace UnnamedCoin.Bitcoin.Features.RPC
{
    public class RPCJsonMvcOptionsSetup : ConfigureOptions<MvcOptions>
    {
        ...
        ///     <see cref="T:Microsoft.AspNetCore.Mvc.Formatters.Json.Internal.MvcJsonMvcOptionsSetup" />.
        /// </summary>
        /// <param name="loggerFactory">The <see cref="T:Microsoft.Extensions.Logging.ILoggerFactory" />.</param>
        /// <param name="jsonOptions"></param>
        /// <param name="charPool"></param>
        /// <param name="objectPoolProvider"></param>
        public RPCJsonMvcOptionsSetup(ILoggerFactory loggerFactory, IOptions<MvcJsonOptions> jsonOptions,
            ArrayPool<char> charPool, ObjectPoolProvider objectPoolProvider)
            : base(delegate(MvcOptions options)
            {
                ConfigureMvc(options, jsonOptions.Value.SerializerSettings, loggerFactory, charPool,
                    objectPoolProvider);
            })
        {
        }
        ...
        public static void ConfigureMvc(MvcOptions options, JsonSerializerSettings serializerSettings,
            ILoggerFactory loggerFactory, ArrayPool<char> charPool, ObjectPoolProvider objectPoolProvider)
        {
