...
namespace UnnamedCoin.Bitcoin.Features.RPC
{
    ...
    public class IPAddressBlock
    {
        ...
        public bool Contains(IPAddress address)
        {
            ...
            var blockAddrBytes = this.BlockAddress.GetAddressBytes();
            ...
            var maskBytesLength = this.CIDRSuffix / 8;
            var addressBytes = address.GetAddressBytes();
            for (var i = 0; i < maskBytesLength; i++)
            ...
            if (this.CIDRSuffix % 8 != 0)
            {
                ...
                var byteMask = (byte) ~(0xff >> (this.CIDRSuffix % 8));
