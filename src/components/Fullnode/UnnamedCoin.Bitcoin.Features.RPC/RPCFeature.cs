...
namespace UnnamedCoin.Bitcoin.Features.RPC
{
    public class RPCFeature : FullNodeFeature
    {
        ...
        public RPCFeature(IFullNodeBuilder fullNodeBuilder, FullNode fullNode, NodeSettings nodeSettings,
            ILoggerFactory loggerFactory, RpcSettings rpcSettings)
        {
        ...
        public override Task InitializeAsync()
        {
            if (this.rpcSettings.Server)
            {
                ...
                this.fullNode.RPCHost = new WebHostBuilder()
                    ...
                    {
                        if (this.fullNodeBuilder != null && this.fullNodeBuilder.Services != null &&
                            this.fullNode != null)
                ...
                this.logger.LogInformation("RPC Server listening on: " + Environment.NewLine +
                                           string.Join(Environment.NewLine, this.rpcSettings.GetUrls()));
            }
            else
            {
